...
product_service_url = "https://anilas-product-cart-service.onrender.com"
...
def get_cart(user_id):
    ...
    user_cart = next((cart for cart in carts if cart.get("user_id") == user_id), None)
    
    if user_cart:
        return jsonify({'user_id': user_id, 'cart_contents': user_cart})
    else:
        ...
        if product:
            ...
            if item:
                ...
                if product_quantity >= quantity:
                    ...
                    product_service_update_url = f'https://anilas-product-cart-service.onrender.com/{product_id}'
